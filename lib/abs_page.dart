    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(child: Column( children: [
          Container(
            ...
            child: const Center(
                child: Text('Plank or 90 On Bar',style: TextStyle(color: Colors.tealAccent,fontSize: 30))
            ),
          ),
          Row( children: [
            SizedBox( width: 200.0, height: 250.0, child: Image.asset('images/Plank.png'),),
            SizedBox( width: 200.0, height: 250.0, child: Image.asset('images/90Bar.png'),),
          ]),
          Row(
